document.addEventListener("DOMContentLoaded", () => {
  ...
  whyInfos.forEach((info) => {
    const { span, h3, p } = info; // Destructure whyInfos objects then...
  ...
  const accordionItem = [
    {
      ...
      answer:
        "Sharing story on our app is simple. Just sign up for an account, \
          navigate to the My Collections section, click 'Share Story' upload \
          your file and fill up the form. ",
    },
    {
      question: "Are there different genres available?",
      answer:
        "Yes! Our app offers a wide range of genres to suit diverse reading \
    ...
    },
    {
      ...
      answer:
        "Our personalized recommendation system utilizes advanced algorithms \
    ...
    },
    {
      ...
      answer:
        "Currently, our app requires an internet connection to access and read stories. ",
    },
    {
      question: "Can I provide feedback or report issues on your app?",
      answer:
        "Absolutely! We value user feedback and encourage you to provide your \
